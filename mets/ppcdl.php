				...
				<div class="col-md-12 about-grid">
					...
					<div class="col-md-9 about-grid">
						...
						<div class="col-md-12 cols_question">
							<a target="_blank" href="admin/uploads/<?php echo $pf['form'];?>"><?php echo $pf['form'];?></a>
						</div>
						<?php } ?>-->
						<div class="col-md-12 cols_question">
							<a target="_blank" href="ppcdl/9_PPCDL_Set_D_Dec_Uline.pdf">9 PPCDL Set D Dec Uline.pdf</a>
						</div>
						<div class="col-md-12 cols_question">
							<a target="_blank" href="ppcdl/9_PPCDL_Set_D_Dec.pdf">9 PPCDL Set D Dec.pdf</a>
						</div>
						
						<div class="col-md-12 cols_question">
							<a target="_blank" href="admin/uploads/Common_mistakes.pdf">Common mistakes</a>
						</div>
						<div class="col-md-12 cols_question">
							<a target="_blank" href="admin/uploads/Forms_Medical_report.doc">Medical Report form</a>
						</div>
					</div>
				</div>
				<div class="clearfix"> </div>
