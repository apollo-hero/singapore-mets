    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
         ...
         <?php show_message();?>
				...
				?>
                        ...
                        <tr>
							...
							<td>
							   ...
							   ?>
                            	<a href="javascript:;" onClick="javascript:hide_course('<?php echo pg_link("mode=training&pg=closed_training_list&start=".$start."&edit_id=".$result['course_training_id'])?>');" title="hide">Hide this course</a>
                           	<?php
							}
							?>
							</td>
            ...
            <div class="pagination"><?php $paging_table?> </div>
