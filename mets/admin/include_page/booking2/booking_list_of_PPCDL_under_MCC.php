...
$argu2	= 	'';
$limit	=	10;
$seltab	=	"select * from booking_details where course_id  = 2 order by booking_id desc";	
			...
			while($result = mysqli_fetch_array($res_query)){
				...
				?>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="<?php echo pg_link("mode=booking&pg=view_details_for_PPCDL_under_MCC&booking_id=".$result['booking_id']."&pg_name=booking_list_of_PPCDL_under_MCC&start=".$start)?>" title="View"><i class="icon-tag"></i></a> </td>
                            
                             <td>
                            <a href="<?php echo pg_link("mode=booking&pg=edit_booking_for_PPCDL_under_MCC&edit_id=".$result['booking_id'])?>" title="Edit"><i class="icon-pencil"></i></a>
