            ...
            <div class="well">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane active in" id="home">
                       ...
                       <label><b>Preferred Date : </b><?php echo $result['preferred_date']?></label><br  />
                       
                       
                       <label><b>Registerd as : </b><?php echo $result['registering_as']?></label><br  />
                    
                         
                         <?php if($result['registering_as']=='Groupon/Deal.com/Other Vouchers'){?> 
                           
                            <label><b>Groupon / Deal.com Voucher Code : </b><?php echo $voucher_code?></label><br  />
                           
                            
                            <label><b>Groupon Security Code : </b><?php echo $security_code?></label>
