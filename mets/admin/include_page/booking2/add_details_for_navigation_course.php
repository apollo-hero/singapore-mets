...
<div class="content">
    ...
    <div class="header">
        ...
        <h1 class="page-title">Add Booking Details for Navigation Course</h1>
    </div>
            ...
            <div class="well">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane active in" id="home">
						...
						<?php    $schedule = mysqli_query($con, "select * from training_schedules where course_id = '3' order by course_training_id asc ");?>
						...
						<?	while($show_schedule = mysqli_fetch_array($schedule)){
                            ...
                            <input type="text" value="<?php echo $preferred_date?>"  name="preferred_date" id="preferred_date" class="input-xlarge">
                            ...
                            <label class="radio"><input type="radio" onclick="groupon();" value="Full-time Student/NSF"  name="register" id="radio1" class="input-radio">Full-time Student / NSF  $270 </label>
                            
                            <label class="radio"><input type="radio" onclick="groupon();" value="Group of 3 or more"  name="register" id="radio2" class="input-radio">Group of 3 or more  $300 </label>
                            <label class="radio"><input type="radio" onclick="groupon();" value="Working Adult"  name="register" id="radio3" class="input-radio">Working Adult  $340 </label>
                            
                            <label class="radio"><input type="radio"  onclick="groupon();" value="Groupon/Deal.com/Other Vouchers"  name="register" id="radio4" class="input-radio">Groupon / Deal.com / Other Vouchers  $168 / $188(Only at MCC)</label>
