        ...
        <div class="row-fluid">
         ...
         <?php show_message();?>
            ...
            <div class="btn-toolbar">
               <!--  <a href="<?php echo pg_link("mode=booking&pg=add_details_for_PPCDL_under_MCC&course_id=2")?>"  title="Add New Booking" class="btn btn-primary"><i class="icon-plus"></i> New Booking</a> -->
			...
			while($result = mysqli_fetch_array($res_query)){
				...
				?>
                        ...
                        <tr>
                          ...
                          <?php if($result['course_id']==1){?>   
                         
                          <a href="<?php echo pg_link("mode=booking&pg=view_details_for_premium_PPCDL&booking_id=".$result['booking_id']."&pg_name=booking_list&start=".$start)?>" title="View"><i class="icon-tag"></i></a>  
						  <?php }else if($result['course_id']==2){?>
                         
                          <a href="<?php echo pg_link("mode=booking&pg=view_details_for_PPCDL_under_MCC&booking_id=".$result['booking_id']."&pg_name=booking_list&start=".$start)?>" title="View"><i class="icon-tag"></i></a>
                          
                          <?php }else if($result['course_id']==3){?>
                        
                          <a href="<?php echo pg_link("mode=booking&pg=view_details_for_navigation_course&booking_id=".$result['booking_id']."&pg_name=booking_list&start=".$start)?>" title="View"><i class="icon-tag"></i></a> 
                          <?php }?>
