    ...
    <div class="container-fluid">
        ...
        <?php show_message();?>
            ...
            <div class="btn-toolbar">
                ...
                <button class="btn" type="reset"  onClick="javascript:location.href='<?php echo pg_link("mode=booking&pg=booking_list_of_PPCDL_under_MCC")?>';">Back</button>
                    <div class="btn-group">
                    </div>
            </div>
            ...
            <div class="well">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane active in" id="home">
                     ...
                     <?php      
  $schedule = mysqli_query($con, "select * from training_schedules where course_id='2'  and start_date >= '".date("Y-m-d")."' and training_stat='O' and stat='Y' order by start_date asc");?>
					
                    	<table class="tr-schedule"><?php
