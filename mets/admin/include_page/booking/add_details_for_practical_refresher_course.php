...
<div class="content">
    ...
    <div class="container-fluid">
            ...
            <div class="well">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane active in" id="home">
						...
						<input type="text" name="m4761aname" id="m4761aname" value="<?php echo $m4761aname?>" size="10" maxlength="255"  class="input-xlarge"/>
                        
                     
                        <label>Phone</label>
						<input type="text" name="m4761aphone" id="m4761aphone" class="input-xlarge" value="<?php if($m4761aphone){ echo $m4761aphone;}else echo '65';?>" size="10" maxlength="255" />

                    
                        <label>Email</label>
                        
                        <input type="text" name="m4761aemail" id="m4761aemail" value="<?php echo $m4761aemail?>" class="input-xlarge" size="10" maxlength="255" />
		...
		if($m4761adate)
		{
			...
			$str15 = mysqli_query($con, "select * from refresher_training where training_day= '".$day."' and refresher_training_id not in (select refresher_training_id from refresher_training_schedules where booking_status='Y' and booking_date='".$m4761adate."') order by start_time");
