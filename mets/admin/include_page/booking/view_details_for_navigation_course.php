                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane active in" id="home">
                       ...
                       <label><b>Registerd as : </b><?php echo $result['registering_as']?></label><br  />
                         ...
                         <?php if($result['registering_as']=='Groupon'){?> 
                           
                            <label><b>Groupon / Deal.com Voucher Code : </b><?php echo $result['voucher_code']?></label><br  />
                           
                            
                            <label><b>Groupon Security Code : </b><?php echo $result['groupon_security_code']?></label>
