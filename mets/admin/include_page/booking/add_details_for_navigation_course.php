            ...
            <div class="well">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane active in" id="home">
						...
						<?php    $schedule = mysqli_query($con, "select * from training_schedules where course_id='3' and start_date >= '".date("Y-m-d")."' and training_stat='O'  and stat='Y' order by start_date asc");?>
