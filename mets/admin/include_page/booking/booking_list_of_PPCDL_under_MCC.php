        ...
        <div class="row-fluid">
         ...
         <?php show_message();?>
            ...
            <div class="btn-toolbar">
                 <a href="<?php echo pg_link("mode=booking&pg=add_details_for_PPCDL_under_MCC&course_id=2")?>"  title="Add New Booking" class="btn btn-primary"><i class="icon-plus"></i> New Booking - PPCDL under MCC</a>
