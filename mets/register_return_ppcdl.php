			...
			<div class="about-grids">
				<div class="col-md-12 about-grid">
					...
					<h4 class="h4_sub_title">Powered Pleasure Cruise Driving License</h4>
					 <div class="col-sm-12">
					<h5 class="h5_sub_title"  style="text-align:center;">Registration Successfull</h5>
					</div> 
					<form class="form-horizontal">
  <div class="form-group" style="text-align:center;">
  <p>You have successfully registered for the PPCDL under MCC Course. You will receive a confirmation email within 2 working days. Thank You.</p>   
