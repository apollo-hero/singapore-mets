        ...
        <div class="row-fluid">
         ...
         <?php show_message();?>
            ...
            <div class="btn-toolbar">
                <!-- <a href="<?=pg_link("mode=booking&pg=add_details_for_premium_PPCDL&course_id=1")?>"  title="Add New Booking" class="btn btn-primary"><i class="icon-plus"></i> New Booking</a> -->
			...
			while($result = mysql_fetch_array($res_query)){
				...
				?>
                        ...
                        <tr>
                            ...
                            <td><?=$result['noks_name']?></td>
                            <td><?=$result['noks_phone']?></td>
							
                            <td>
                            <a href="<?=pg_link("mode=booking&pg=view_details_for_premium_PPCDL&booking_id=".$result['booking_id']."&pg_name=booking_list_of_premium_PPCDL&start=".$start)?>" title="View"><i class="icon-tag"></i></a> </td>
                             <td>
                            <a href="<?=pg_link("mode=booking&pg=edit_booking_for_premium_PPCDL&edit_id=".$result['booking_id'])?>" title="Edit"><i class="icon-pencil"></i></a>
