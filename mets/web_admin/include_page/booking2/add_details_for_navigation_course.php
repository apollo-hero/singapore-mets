            ...
            <div class="well">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane active in" id="home">
						...
						<?    $schedule = mysql_query("select * from training_schedules where course_id = '3' order by course_training_id asc ");?>
						...
						<?	while($show_schedule = mysql_fetch_array($schedule)){
                            ...
                            <input type="text" value="<?=$preferred_date?>"  name="preferred_date" id="preferred_date" class="input-xlarge">
