				...
				?>
                        ...
                        <tr>
							...
							<td>
							   ...
							   ?>
                            	<a href="javascript:;;" onClick="javascript:hide_course('<?=pg_link("mode=training&pg=open_training_list&start=".$start."&edit_id=".$result['course_training_id'])?>');" title="hide">Hide this course</a>
                           	<?
							}
							?>
                            </td>
