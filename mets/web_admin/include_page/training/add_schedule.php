                    ...
                    <div class="tab-pane active in" id="home">
                      ...
                      <select name="course_id" id="course_id" >
                           ...
                           <option value="3" <?php if($result['course_id']==3){?> selected="selected" <? }?> >Advance Navigation Course</option>
                            <option value="2" <?php if($result['course_id']==3){?> selected="selected" <? }?>>PPCDL under MCC</option>
                                                        
                      </select>
                         
                        <label><strong>Start Date</strong></label>
                        <input type="text" value="<?=$start_date?>"  name="start_date" id="start_date" class="input-xlarge">
                        
                        <label><strong>End Date</strong></label>
                        <input type="text" value="<?=$end_date?>"  name="end_date" id="end_date" class="input-xlarge">
                        ...
                        <div id="l_stat" style="display:none">
                            ...
                            <input type="text" value="<?=$max_limit?>"  name="max_limit" id="max_limit" class="input-xlarge">
                        </div>
