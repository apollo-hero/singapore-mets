 ...
 $pg_head = 'training_list';
 	if($_POST)
	{
		...
		$str = mysql_query("select count(*) as ct from refresher_training_schedules where refresher_training_id = '".$refresher_training_id."'");
	...
	$rem_hr='';
	$str4 = mysql_query("select * from refresher_training  where training_day='".$training_day."' and refresher_training_id <> '".$refresher_training_id."'");
