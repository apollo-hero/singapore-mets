        ...
        <div class="row-fluid">
         ...
         <?php show_message();?>
            ...
            <div class="btn-toolbar">
              <a href="<?=pg_link("mode=booking&pg=add_details_for_navigation_course&course_id=3")?>"  title="Add New Booking" class="btn btn-primary"><i class="icon-plus"></i> New Booking - Advance Navigation Course</a> 
