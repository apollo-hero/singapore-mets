...
$str15 = mysql_query("select * from booking_details where booking_id= '".$booking_id."'");
            ...
            <div class="well">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane active in" id="home">
                       ...
                       <?
$str1533 = mysql_query("select count(*) as ct from group_members where booking_id= '".$booking_id."'");
$result_batch33 = mysql_fetch_array($str1533);
...
<div class="box_register_table">
                <table width="100%" border="0" cellspacing="0" cellpadding="1" class="table_two">
                      <tr>
                        <td><b>Name:</b> <?=strip($result_batch['booking_name'])?></td>
                      </tr>
                       <tr>
                        <td><b>Nationality:</b> <?=strip($result_batch['nationality'])?></td>
                    </tr>
                       <tr>
                        <td><b>Nric:</b> <?=strip($result_batch['nric_passport_no'])?></td>
                    </tr>
                       <tr>
                        <td><b>Phone:</b> <?=strip($result_batch['phone'])?></td>
                    </tr>
                       <tr>
                        <td><b>Email:</b> <?=strip($result_batch['email'])?></td>
                    </tr>
                       <tr>
                        <td><b>Address:</b> <?=strip($result_batch['address'])?></td>
                      </tr>
                         <tr>
                        <td><b>Nokn:</b> <?=strip($result_batch['noks_name'])?></td>
                    </tr>
                       <tr>
                        <td><b>Nokp:</b> <?=strip($result_batch['noks_phone'])?></td>
                    </tr>
                  </table>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="1" class="table_two">
     <tr>
                        <td><b>Training:</b>  <?=strip($result_batch['course_name'])?></td>
                      </tr>
                       <tr>
                        <td><b>Date:</b>  <?=strip($result_batch['preferred_date'])?></td>
                    </tr>
                       <tr>
                        <td><b>Register:</b>  <?=strip($result_batch['registering_as'])?></td>
                    </tr>
                      <tr>
                        <td><b>Amount:</b> <?=strip($result_batch['amount'])?> SGD</td>
                      </tr>
                      <tr>
...
<div class="box_register_table">
     ...
     <tr>
                      ...
                      <tr>
                        <td><b>Amount:</b>  <?=strip($result_batch['payable_amount'])?></td>
                      </tr>
					</table>
                  </div>
