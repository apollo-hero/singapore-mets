 ...
 $pg_head = 'booking_list_of_practical_refresher_course';
	...
	$str = mysql_query("select * from refresher_training_schedules where booking_id = '".$edit_id."'");
...
<div class="content">
    ...
    <div class="container-fluid">
            ...
            <div class="well">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane active in" id="home">
                        ...
                        <label> Name</label>
                        <input type="text" value="<?=$result['name']?>"  name="name" id="name" class="input-xlarge">
		...
		if($m4761adate)
		{
			...
			$str15 = mysql_query("select * from refresher_training where training_day= '".$day."' and (refresher_training_id = '".$refresher_training."' or refresher_training_id not in (select refresher_training_id from refresher_training_schedules where booking_status='Y' and booking_date='".$m4761adate."')) order by start_time");
