...
<!--  <div class="form-group">
 ...
 <h5 class="h5_sub_title">PPCDL Course Details</h5>
  ...
  <div class="form-group">
    <label class="control-label col-sm-4">PPCDL Course to Attend:<span class="red">*</span></label>
    <div class="col-sm-8">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="preferred_date" name="preferred_date" placeholder="" required>
...
(for determining fees)</label>
 ...
 <tr>
 <td><input type="radio" value="Full-time Student/NSF" name="registering_as"></td>
 <td> Full-time Student/NSF </td>
 <td> $320</td>
 </tr>
 <tr>
 <td><input type="radio" value="Group of 3 or more" name="registering_as"></td>
 <td> Group of 3 or more </td>
 <td> $360</td>
 </tr>
  <tr>
 <td><input type="radio" value="Working Adult" name="registering_as"></td>
 <td> Working Adult </td>
 <td> $400</td>
 </tr>
   <tr>
 <td><input type="radio" value="FAVE" name="registering_as" id="registering_as"></td>
 <td> FAVE </td>
 <td></td>
 </tr>
 </table>
 ...
 <td> $400</td>
  ...
  <tr>
 <td><input type="radio" value="Groupon(Week Days)" name="registering_as"></td>
 <td> Week Days </td>
 <td> </td>
 </tr>
 <tr>
 <td><input type="radio" value="Groupon(Week Ends)" name="registering_as"></td>
 <td> Week Ends </td>
 <td> </td>
 </tr>
 </table>
  ...
  <tr>
 <td><input type="radio" value="METS promotions(Week Days)" name="registering_as"></td>
 <td> Week Days </td>
 <td> </td>
 </tr>
 <tr>
 <td><input type="radio" value="METS promotions(Week Ends)" name="registering_as"></td>
 <td> Week Ends </td>
 <td> </td>
 </tr>
 </table>
